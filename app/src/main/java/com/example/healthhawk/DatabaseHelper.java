...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public static final String WORKOUTS_COLUMN_WORKOUT_ID      = "workout_id";
    public static final String WORKOUTS_COLUMN_USER            = "user";
    ...
    public static final String WORKOUTS_COLUMN_WORKOUT_TYPE_ID = "workout_type_id";
    ...
    private static final String CREATE_WORKOUTS = "CREATE TABLE " +WORKOUTS_TABLE_NAME+"("
            ...
            +WORKOUTS_COLUMN_USER         	 + " Text, "
            +WORKOUTS_COLUMN_WORKOUT_NAME    + " Text, "
            +WORKOUTS_COLUMN_SETS   		 + " integer, "
            +WORKOUTS_COLUMN_REPS 	   		 + " integer, "
            +WORKOUTS_COLUMN_DESCRIPTION  	 + " Text,"
            +WORKOUTS_COLUMN_WORKOUT_TYPE_ID + " integer)";
